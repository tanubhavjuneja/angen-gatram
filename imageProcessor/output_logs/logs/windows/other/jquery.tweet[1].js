(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["vagabondish"],              // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
    ...
    return this.each(function(){
      ...
      $.getJSON(url, function(data){
        ...
        $.each(data.results, function(i,item){
          ...
          list.append('<li>' + avatar + join + text + ' - <strong>' + item.from_user + '</strong> ' + date + '</li>');
