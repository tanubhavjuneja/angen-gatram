...
*/
		...
		_init: function() {
			...
			if(this.html.used) {
				...
				if(this.html.audio.available) {
					//WBUR: Add title attribute to html5 element for chartbeat tracking
					//this.htmlElement.audio.title = $('.mp-title').html().replace('"', '\""');
		...
		jPlayerFlashEvent: function(eventType, status) { // Called from Flash
			...
			// WBUR: Added initial duration for flash
			if( Object.getOwnPropertyNames(this.status.media).length > 0 ) {
				this.css.jq.duration.text(this.status.media.duration);
			}
...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(media) {
			...
			// WBUR:  Added duration to playlist item html
			listItem += "<a href='javascript:;' class='clearfix " + this.options.playlistOptions.itemClass + "' tabindex='1'><span class='mp-truncate'>" + media.title + "</span>" + (media.artist ? " <span class='jp-artist'>by " + media.artist + "</span>" : "") + (media.duration ? " <span class='jp-pl-duration'>" + media.duration + "</span>" : "") + "<span class='jp-upnext'></span></a>";
			listItem += "</div></li>";
		...
		select: function(index) {
			...
			/* WBUR - Add 'Up Next' functionality */
			var next = (index < this.playlist.length) ? index+2 : index;
			$(".jp-upnext").html('');
			$(this.cssSelector.playlist + " ul li:nth-child("+next+") .jp-upnext").append('up next');
